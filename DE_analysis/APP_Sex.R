...
run_deseq_APP_Sex <- function(cnts, samples,  count_filter, condition) {
  ...
  dds <- DESeqDataSetFromMatrix(countData=cnts2, colData=samples2, design= ~ Sex + APP) 
